...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(6), __webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = function(CardNode, cards) {
	  var randomCards;
	  randomCards = cards.sort(function() {
	    return 0.5 - Math.random();
	  }).slice(0, 5);
	  return randomCards.forEach(function(cardInfo) {
	    var cardNode;
	    cardNode = new CardNode(cardInfo);
	    return document.getElementById("cards-container").appendChild(cardNode.build());
	  });
